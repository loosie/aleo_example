...
class XgboostTranspiler(BoostingTranspiler):
    ...
    def __init__(self, model, quantize_bits: int = 8):
        ...
        self._dfs = []
        df = trees.trees_to_dataframe()  # This should get all trees at once if your XGBoost version supports it
        ...
        if self.is_regression:
            ...
            for c in range(self.n_classes):
                class_df = df[df['Tree'] // self.n_estimators == c].reset_index(drop=True)
